...
export const LESSONS = {
  ...
  L4: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: '____ لِلَّهِ رَبِّ ٱلْعَـٰلَمِينَ',
        ayahRef: '1:2',
      ...
      {
        type: 'fill-the-gap',
        ayah: 'ٱلْحَمْدُ ____ رَبِّ ٱلْعَـٰلَمِينَ',
        ayahRef: '1:2',
  ...
  L8: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: 'إِيَّاكَ ____ وَإِيَّاكَ نَسْتَعِينُ',
        ayahRef: '1:5',
  ...
  L11: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: '____ ٱلْمَغْضُوبِ عَلَيْهِمْ وَلَا ٱلضَّآلِّينَ',
        ayahRef: '1:7',
      ...
      {
        type: 'fill-the-gap',
        ayah: 'غَيْرِ ٱلْمَغْضُوبِ عَلَيْهِمْ ____ ٱلضَّآلِّينَ',
        ayahRef: '1:7',
      ...
      },
      {
        ...
        ayah: 'غَيْرِ ٱلْمَغْضُوبِ عَلَيْهِمْ وَلَا ٱلضَّآلِّينَ',
        ayahRef: '1:7',
        translation: ['not', 'those who earned anger,', 'and not', 'those who went astray'],
      },
      {
        type: 'cold-read',
  ...
  L14: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: 'ذَٰلِكَ ٱلْكِتَابُ لَا رَيْبَ ____',
        ayahRef: '2:2',
  ...
  L31: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: 'قُلْ ____ بِرَبِّ ٱلْفَلَقِ',
        ayahRef: '113:1',
  ...
  L35: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: 'قُلْ أَعُوذُ بِرَبِّ ____',
        ayahRef: '114:1',
  ...
  L42: {
    ...
    exercises: [
      ...
      },
      {
        ...
        ayah: 'إِلَّا ٱلَّذِينَ آمَنُوا',
        ayahRef: '103:3',
        translation: ['Except', 'those who', 'believed'],
      },
      {
        type: 'cold-read',
  ...
  L51: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: 'فَمَن يَعْمَلْ مِثْقَالَ ذَرَّةٍ ____ يَرَهُ',
        ayahRef: '99:7',
      ...
      {
        type: 'fill-the-gap',
        ayah: 'وَمَن يَعْمَلْ مِثْقَالَ ذَرَّةٍ ____ يَرَهُ',
        ayahRef: '99:8',
  ...
  L59: {
    ...
    exercises: [
      ...
      {
        type: 'fill-the-gap',
        ayah: '____ بِٱسْمِ رَبِّكَ ٱلَّذِى خَلَقَ',
        ayahRef: '96:1',
      ...
      {
        type: 'fill-the-gap',
        ayah: 'ٱقْرَأْ بِٱسْمِ رَبِّكَ ٱلَّذِى ____',
        ayahRef: '96:1',
